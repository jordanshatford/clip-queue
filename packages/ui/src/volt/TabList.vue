...
const navButton = `!absolute flex-shrink-0 top-0 z-20 h-full flex items-center justify-center cursor-pointer
        bg-surface-0 dark:bg-surface-950 text-surface-500 dark:text-surface-400 hover:text-surface-700 dark:hover:text-surface-0 w-10
...
const theme = ref<TabListPassThroughOptions>({
    ...
    tabList: `relative flex bg-surface-0 dark:bg-surface-950 border-b border-surface-200 dark:border-surface-700
