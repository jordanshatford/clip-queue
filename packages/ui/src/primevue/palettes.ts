type ColorPalette = [
  string | undefined, // 0 (undefined with primary colors)
  string, // 50
  string, // 100
  string, // 200
  string, // 300
...
const INCREMENTS = [0, 50, 100, 200, 300, 400, 500, 600, 700, 800, 900, 950] as const
...
export function setColorPalette(type: 'primary' | 'surface', palette: ColorPalette) {
  palette.forEach((color, index) => {
    if (color) {
      ...
      document.documentElement.style.setProperty(`--${type}-${increment}`, color)
    }
  })
}
