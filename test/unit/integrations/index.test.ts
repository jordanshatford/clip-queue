...
describe('integrations', () => {
  it.each([
    ...
    ['https://www.rumble.com/testid-some-test-title.html', IntegrationID.RUMBLE_VIDEOS],
    ['https://rumble.com', undefined],
    ['https://rumble.com/testid-some-test-title.html', IntegrationID.RUMBLE_VIDEOS],
    ['https://rumble.com/testid-some-test-title.html?start=60', IntegrationID.RUMBLE_VIDEOS],
    ['https://rumble.com/embed', undefined],
    ['https://rumble.com/embed/', undefined],
    ['https://rumble.com/embed/testvideo', IntegrationID.RUMBLE_VIDEOS],
    ['https://rumble.com/embed/testvideo/?start=10', IntegrationID.RUMBLE_VIDEOS],
    ['https://rumble.com/shorts', undefined],
    ['https://rumble.com/shorts/', undefined],
    ['https://www.rumble.com/shorts/testshort', IntegrationID.RUMBLE_SHORTS],
    ['https://rumble.com/shorts/testshort', IntegrationID.RUMBLE_SHORTS],
  ])(
