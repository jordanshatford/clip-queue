<template>
  <div>
    <twitch-clip-player
      ...
      @next="clips.next()"
    />
    <div v-else class="text-center text-zinc-700 dark:text-zinc-300">
      <p class="text-5xl font-extrabold text-violet-500 p-5">Queue open!</p>
      <p class="dark:text-zinc-300">Start sending clips now for them to be added to the queue!</p>
