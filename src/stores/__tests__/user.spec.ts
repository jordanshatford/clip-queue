...
describe('user.ts', () => {
  ...
  // ('can use twitch information to login', async () => {
  //   const user = useUser()
  ...
  // ('can use twitch login information if successfully fetched', async () => {
  ...
  // ('updates the login info if the username changes', async () => {
  //   const user = useUser()
