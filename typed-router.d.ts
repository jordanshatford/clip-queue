...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/integrations/[id]': RouteRecordInfo<
      ...
      never
    >
    '/logs': RouteRecordInfo<'/logs', '/logs', Record<never, never>, Record<never, never>, never>
    '/queue': RouteRecordInfo<'/queue', '/queue', Record<never, never>, Record<never, never>, never>
  ...
  export interface _RouteFileInfoMap {
    ...
    'src/pages/settings/logs.vue': {
      routes: '/settings/logs'
      views: never
    }
    'src/pages/settings/other.vue': {
      routes: '/settings/other'
      views: never
    }
